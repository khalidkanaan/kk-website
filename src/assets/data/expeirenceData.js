...
const introData = {
    HealthCanada: {
        ...
        description: [
            ...
            "Researched Azure Key Vault and employed secure files feature in Azure DevOps pipeline for managing pipeline secrets.",
            "Configured Docker installation in Azure DevOps pipeline to achieve seamless interaction with Artifactory Docker registry.",
            ...
            "Wrote terraform scripts to automate Dockerfile execution and facilitate the uploading of Docker images to the Artifactory Docker registry.",
            ...
            "Developed the Health Canada ‘JiraCSV Genie’ application using .NET framework and C#, enabling seamless automation of Jira tasks through user-controlled PowerShell script execution and CSV generation.",
